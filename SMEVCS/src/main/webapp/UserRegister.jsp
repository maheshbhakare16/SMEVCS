    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <li><a class="nav-link scrollto " href="http://127.0.0.1:5000/">Connect to ChatBot</a></li>         
          <li><a class="nav-link scrollto" href="UserLogin.jsp">Login</a></li>
          <li><a class="nav-link scrollto active" href="UserRegister.jsp">SignUp</a></li>
        </ul>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <form action="UserRegistrationController" method="post" id="form1" role="form" class="email-form">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="name" id="subject" placeholder="Name" required>
              </div>
               <div class="form-group mt-3">
                <input type="text" class="form-control" name="address" id="subject" placeholder="Address" required>
              </div>
               <div class="form-group mt-3">
                <input type="text" class="form-control" name="mobile_no" id="subject" placeholder="Mobile No" required>
              </div>
              <div class="form-group mt-3">
              ...
              <div class="form-group mt-3">
                <input type="password" class="form-control" name="conf_password" id="subject" placeholder="Confirm Password" required>
              </div>
               <div class="form-group mt-3">
